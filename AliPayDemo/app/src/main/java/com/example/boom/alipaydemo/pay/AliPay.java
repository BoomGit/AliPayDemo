package com.example.boom.alipaydemo.pay;
...
public class AliPay {
    ...
    public AliPay setPID(String PID) {
        this.PID = PID;
        return this;
    }
    ...
    public static class Builder {
        ...
        public AliPay.Builder setPID(String PID) {
            this.PID = PID;
            return this;
        }
        ...
        public void pay() {
            if (TextUtils.isEmpty(PID) || TextUtils.isEmpty(RSA_PRIVATE) || TextUtils.isEmpty(SELLER)) {
                new AlertDialog.Builder(mActivity).setTitle("警告").setMessage("需要配置PID | RSA_PRIVATE| SELLER")
